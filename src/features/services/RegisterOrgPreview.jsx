...
import { submitRegisterOrg } from '../../services/registerOrgService';
...
export default function RegisterOrgPreview() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Delegate business logic to registerOrgService
      await submitRegisterOrg(dataUrl, formData, coLeaders, members, councilMembers, refNumber, user);

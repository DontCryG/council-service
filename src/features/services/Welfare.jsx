      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-[24px] p-8 shadow-xl backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Button type="submit" className="w-full h-14 text-base shadow-lg shadow-blue-500/20 bg-blue-600 hover:bg-blue-500 text-white rounded-xl" isLoading={isSubmitting}>

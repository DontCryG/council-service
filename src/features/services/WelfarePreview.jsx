  ...
  return (
    <div className="max-w-[800px] mx-auto py-4 px-2 md:px-0 animate-in fade-in slide-in-from-right-16 duration-700 ease-out">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-2xl font-bold text-white mb-1">ตรวจสอบความถูกต้องก่อนยืนยัน</h2>
          <p className="text-slate-400 text-sm">ตรวจสอบแบบฟอร์มสวัสดิการก่อนส่งคำขอ</p>
        </div>
        <Button variant="ghost" onClick={() => navigate('/welfare', { state: { formData, vehicles } })} className="text-slate-400 hover:text-white hover:bg-slate-800 rounded-xl">
          <ArrowLeft size={20} className="mr-2" /> <span className="hidden sm:inline">กลับไปแก้ไข</span>
        </Button>
      </div>
